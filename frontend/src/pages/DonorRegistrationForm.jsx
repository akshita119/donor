...
function DonorRegistrationForm() {
  ...
  // Validate form data
  const validateForm = () => {
    if (!formData.name || !formData.bloodType || !formData.age || !formData.city || !formData.contact || !formData.pinCode || !formData.gender || !formData.email || !formData.password) {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      setError('');
      // Submit form logic, e.g., sending data to backend
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
      <section className="bg-[#E63946] text-white text-center py-16">
        ...
        <p className="mt-4 text-xl">Join the cause and start saving lives by donating blood.</p>
      </section>

      <section className="bg-white py-16 px-6">
        <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-gray-50 p-8 rounded-lg shadow-lg">
          <h2 className="text-2xl font-semibold text-center text-[#E63946] mb-6">Donor Registration Form</h2>
          ...
          {/* Pin Code field */}
          <div className="mb-4">
            <label htmlFor="pinCode" className="block text-lg font-medium text-gray-700">Pin Code</label>
            <input
              type="text"
              id="pinCode"
              name="pinCode"
      ...
      <section className="text-center py-8 bg-gray-100">
        <p className="text-lg text-gray-700">
          ...
          <Link to="/login-donor" className="text-[#E63946] font-semibold">Login as Donor</Link>
        </p>
      </section>
    </div>
  );
